 ...
 */
void ArvoreBinaria::mostrarCentral() {
   cout << "[ ";
   mostrarCentral(raiz);
   cout << "]\n";
}
 ...
 * @param i No em analise.
 */
void ArvoreBinaria::mostrarCentral(No* i) {
   if (i != NULL) {
 ...
 * @param i No em analise.
 */
void ArvoreBinaria::mostrarPre(No* i) {
   if (i != NULL) {
      cout << i->elemento << " "; // Conteudo do no.
 ...
 * @param i No em analise.
 */
void ArvoreBinaria::mostrarPos(No* i) {
   if (i != NULL) {
